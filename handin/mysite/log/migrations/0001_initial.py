    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(max_length=1, choices=[(b'T', b'Transfer'), (b'D', b'Deposit'), (b'W', b'Withdraw')])),
                ...
                ('amount', djmoney.models.fields.MoneyField(default=Decimal('0'), max_digits=11, decimal_places=2, default_currency=b'USD')),
                ('account_1', models.OneToOneField(related_name='account_1', to='account.Checking_Account')),
                ('account_2', models.OneToOneField(related_name='account_2', null=True, blank=True, to='account.Checking_Account')),
            ],
            options={
                'abstract': False,
            },
